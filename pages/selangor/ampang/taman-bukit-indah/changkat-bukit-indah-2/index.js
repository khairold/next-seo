...
export default function State() {
  return (
    <div>
      <TopNav />
      <CenterContainer>
        <Breadcrumb state="Selangor" city="Ampang" section="Taman Bukit Indah" />
        <h1 class="font-medium text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl tracking-tighter leading-tight text-tmOrange-500">
          Changkat Bukit Indah 2
        </h1>
      </CenterContainer>
      <CenterContainer>
        <div className="py-10 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10 bg-gray-100">
          <div className="text-sm sm:text-base text-gray-400 font-bold">SELECT YOUR BUILDING</div>
          <div>
